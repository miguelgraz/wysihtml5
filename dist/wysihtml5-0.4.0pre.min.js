...
window.rangy=function(){function b(a,b){var c=typeof a[b];return c==l||!(c!=h||!a[b])||"unknown"==c}function c(a,b){return!(typeof a[b]!=h||!a[b])}function a(a,b){return typeof a[b]!=p}function d(a){return function(b,c){for(var d=c.length;d--;)if(!a(b,c[d]))return!1;return!0}}function e(a){return a&&r(a,q)&&v(a,D)}function f(a){window.alert("Rangy not supported in your browser. Reason: "+a);t.initialized=!0;t.supported=!1}function g(){if(!t.initialized){var a,d=!1,l=!1;b(document,"createRange")&&
(a=document.createRange(),r(a,u)&&v(a,n)&&(d=!0),a.detach());(a=c(document,"body")?document.body:document.getElementsByTagName("body")[0])&&b(a,"createTextRange")&&(a=a.createTextRange(),e(a)&&(l=!0));d||l||f("Neither Range nor TextRange are implemented");t.initialized=!0;t.features={implementsDomRange:d,implementsTextRange:l};d=A.concat(w);l=0;for(a=d.length;l<a;++l)try{d[l](t)}catch(h){c(window,"console")&&b(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
...
rangy.createModule("DomUtil",function(b,c){function a(a){for(var b=0;a=a.previousSibling;)b++;return b}function d(a,b){var c=[],d;for(d=a;d;d=d.parentNode)c.push(d);for(d=b;d;d=d.parentNode)if(r(c,d))return d;return null}function e(a,b,d){for(d=d?a:a.parentNode;d;){a=d.parentNode;if(a===b)return d;d=a}return null}function f(a){a=a.nodeType;return 3==a||4==a||8==a}function g(a,b){var d=b.nextSibling,c=b.parentNode;d?c.insertBefore(a,d):c.appendChild(a);return a}function k(a){if(9==a.nodeType)return a;
...
null}};p.prototype={equals:function(a){return this.node===a.node&this.offset==a.offset},inspect:function(){return"[DomPosition("+h(this.node)+":"+this.offset+")]"}};n.prototype={INDEX_SIZE_ERR:1,HIERARCHY_REQUEST_ERR:3,WRONG_DOCUMENT_ERR:4,NO_MODIFICATION_ALLOWED_ERR:7,NOT_FOUND_ERR:8,NOT_SUPPORTED_ERR:9,INVALID_STATE_ERR:11};n.prototype.toString=function(){return this.message};b.dom={arrayContains:r,isHtmlNamespace:function(a){var b;return typeof a.namespaceURI==u||null===(b=a.namespaceURI)||"http://www.w3.org/1999/xhtml"==
b},parentElement:function(a){a=a.parentNode;return 1==a.nodeType?a:null},getNodeIndex:a,getNodeLength:function(a){var b;return f(a)?a.length:(b=a.childNodes)?b.length:0},getCommonAncestor:d,isAncestorOf:function(a,b,d){for(b=d?b:b.parentNode;b;){if(b===a)return!0;b=b.parentNode}return!1},getClosestAncestorIn:e,isCharacterDataNode:f,insertAfter:g,splitDataNode:function(a,b){var d=a.cloneNode(!1);d.deleteData(0,b);a.deleteData(b,a.length-b);g(d,a);return d},getDocument:k,getWindow:function(a){a=k(a);
...
throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(a){return D.isHostObject(a,"body")?a.body:a.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var b;b=a.parentNode;)a=b;return a},comparePoints:function(b,c,l,h){var f;if(b==l)return c===h?0:c<h?-1:1;if(f=e(l,b,!0))return c<=a(f)?-1:1;if(f=e(b,l,!0))return a(f)<h?-1:1;c=d(b,l);b=b===c?c:e(b,c,!0);l=l===c?c:e(l,c,!0);if(b===l)throw Error("comparePoints got to case 4 and childA and childB are the same!");
for(c=c.firstChild;c;){if(c===b)return-1;if(c===l)return 1;c=c.nextSibling}throw Error("Should not be here!");},inspectNode:h,fragmentFromNodeChildren:function(a){for(var b=k(a).createDocumentFragment(),c;c=a.firstChild;)b.appendChild(c);return b},createIterator:function(a){return new l(a)},DomPosition:p};b.DOMException=n});
...
b||a.startOffset!==c,f=a.endContainer!==d||a.endOffset!==l;a.startContainer=b;a.startOffset=c;a.endContainer=d;a.endOffset=l;O(a);e(a,"boundarychange",{startMoved:h,endMoved:f})}function C(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};O(this)}b.requireModules(["DomUtil"]);var m=b.dom,I=m.DomPosition,F=b.DOMException;q.prototype={_current:null,_next:null,_first:null,_last:null,isSingleCharacterDataNode:!1,reset:function(){this._current=
...
if(this.startContainer===this.endContainer&&m.isCharacterDataNode(this.startContainer))return a=this.startContainer.cloneNode(!0),a.data=a.data.slice(this.startOffset,this.endOffset),b=d(this).createDocumentFragment(),b.appendChild(a),b;b=new q(this,!0);a=h(b);b.detach();return a},canSurroundContents:function(){x(this);y(this.startContainer);y(this.endContainer);var b=new q(this,!0),c=b._first&&a(b._first,this)||b._last&&a(b._last,this);b.detach();return!c},surroundContents:function(a){A(a,T);if(!this.canSurroundContents())throw new r("BAD_BOUNDARYPOINTS_ERR");
...
g&&q.endContainer==g&&0==q.startOffset&&q.endOffset==g.length?function(b){this.nativeRange.selectNodeContents(b);a(this)}:function(a){this.setStart(a,0);this.setEnd(a,k.getEndOffset(a))};q.selectNodeContents(g);q.setEnd(g,3);h=document.createRange();h.selectNodeContents(g);h.setEnd(g,4);h.setStart(g,2);-1==q.compareBoundaryPoints(q.START_TO_END,h)&1==q.compareBoundaryPoints(q.END_TO_START,h)?c.compareBoundaryPoints=function(a,b){b=b.nativeRange||b;a==b.START_TO_END?a=b.END_TO_START:a==b.END_TO_START&&
(a=b.START_TO_END);return this.nativeRange.compareBoundaryPoints(a,b)}:c.compareBoundaryPoints=function(a,b){return this.nativeRange.compareBoundaryPoints(a,b.nativeRange||b)};b.util.isHostMethod(q,"createContextualFragment")&&(c.createContextualFragment=function(a){return this.nativeRange.createContextualFragment(a)});f.getBody(document).removeChild(g);q.detach();h.detach()})(),b.createNativeRange=function(a){a=a||document;return a.createRange()};else if(b.features.implementsTextRange){e=function(a){this.textRange=
a;this.refresh()};e.prototype=new k(document);e.prototype.refresh=function(){var b,c,d=this.textRange;b=d.parentElement();var e=d.duplicate();e.collapse(!0);c=e.parentElement();e=d.duplicate();e.collapse(!1);d=e.parentElement();c=c==d?c:f.getCommonAncestor(c,d);c=c==b?c:f.getCommonAncestor(b,c);0==this.textRange.compareEndPoints("StartToEnd",this.textRange)?c=b=a(this.textRange,c,!0,!0):(b=a(this.textRange,c,!0,!1),c=a(this.textRange,c,!1,!1));this.setStart(b.node,b.offset);this.setEnd(c.node,c.offset)};
...
c);return a});e.prototype.getName=function(){return"WrappedRange"};b.WrappedRange=e;b.createRange=function(a){a=a||document;return new e(b.createNativeRange(a))};b.createRangyRange=function(a){a=a||document;return new k(a)};b.createIframeRange=function(a){return b.createRange(f.getIframeDocument(a))};b.createIframeRangyRange=function(a){return b.createRangyRange(f.getIframeDocument(a))};b.addCreateMissingNativeApiListener(function(a){a=a.document;"undefined"==typeof a.createRange&&(a.createRange=
...
d=new A(a.focusNode,a.focusOffset),e="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var h=0,l=a.rangeCount;h<l;++h)b[h]=v.inspect(a.getRangeAt(h));return"["+e+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+d.inspect()+"]"}b.requireModules(["DomUtil","DomRange","WrappedRange"]);b.config.checkSelectionRanges=!0;var r=b.dom,s=b.util,v=b.DomRange,t=b.WrappedRange,w=b.DOMException,A=r.DomPosition,z,E,y=b.util.isHostMethod(window,"getSelection"),
B=b.util.isHostObject(document,"selection"),x=B&&(!y||b.config.preferTextRange);x?(z=d,b.isSelectionValid=function(a){a=(a||window).document;var b=a.selection;return"None"!=b.type||r.getDocument(b.createRange().parentElement())==a}):y?(z=a,b.isSelectionValid=function(){return!0}):c.fail("Neither document.selection or window.getSelection() detected.");b.getNativeSelection=z;var y=z(),L=b.createNativeRange(document),H=r.getBody(document),G=s.areHostObjects(y,s.areHostProperties(y,["anchorOffset","focusOffset"]));
b.features.selectionHasAnchorAndFocus=G;var N=s.isHostMethod(y,"extend");b.features.selectionHasExtend=N;var P="number"==typeof y.rangeCount;b.features.selectionHasRangeCount=P;var O=!1,R=!0;s.areHostMethods(y,["addRange","getRangeAt","removeAllRanges"])&&"number"==typeof y.rangeCount&&b.features.implementsDomRange&&function(){var a=document.createElement("iframe");H.appendChild(a);var b=r.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");b.close();var c=r.getIframeWindow(a).getSelection(),
d=b.documentElement.lastChild.firstChild,b=b.createRange();b.setStart(d,1);b.collapse(!0);c.addRange(b);R=1==c.rangeCount;c.removeAllRanges();var e=b.cloneRange();b.setStart(d,0);e.setEnd(d,2);c.addRange(b);c.addRange(e);O=2==c.rangeCount;b.detach();e.detach();H.removeChild(a)}();b.features.selectionSupportsMultipleRanges=O;b.features.collapsedNonEditableSelectionsSupported=R;var C=!1,m;H&&s.isHostMethod(H,"createControlRange")&&(m=H.createControlRange(),s.areHostProperties(m,["item","add"])&&(C=
!0));b.features.implementsControlRange=C;E=G?function(a){return a.anchorNode===a.focusNode&&a.anchorOffset===a.focusOffset}:function(a){return a.rangeCount?a.getRangeAt(a.rangeCount-1).collapsed:!1};var I;s.isHostMethod(y,"getRangeAt")?I=function(a,b){try{return a.getRangeAt(b)}catch(c){return null}}:G&&(I=function(a){var c=r.getDocument(a.anchorNode),c=b.createRange(c);c.setStart(a.anchorNode,a.anchorOffset);c.setEnd(a.focusNode,a.focusOffset);c.collapsed!==this.isCollapsed&&(c.setStart(a.focusNode,
a.focusOffset),c.setEnd(a.anchorNode,a.anchorOffset));return c});b.getSelection=function(a){a=a||window;var b=a._rangySelection,c=z(a),e=B?d(a):null;b?(b.nativeSelection=c,b.docSelection=e,b.refresh(a)):(b=new n(c,e,a),a._rangySelection=b);return b};b.getIframeSelection=function(a){return b.getSelection(r.getIframeWindow(a))};m=n.prototype;if(!x&&G&&s.areHostMethods(y,["removeAllRanges","addRange"])){m.removeAllRanges=function(){this.nativeSelection.removeAllRanges();f(this)};var F=function(a,c){var d=
v.getRangeDocument(c),d=b.createRange(d);d.collapseToPoint(c.endContainer,c.endOffset);a.nativeSelection.addRange(g(d));a.nativeSelection.extend(c.startContainer,c.startOffset);a.refresh()};m.addRange=P?function(a,c){if(C&&B&&"Control"==this.docSelection.type)p(this,a);else if(c&&N)F(this,a);else{var d;O?d=this.rangeCount:(this.removeAllRanges(),d=0);this.nativeSelection.addRange(g(a));this.rangeCount=this.nativeSelection.rangeCount;this.rangeCount==d+1?(b.config.checkSelectionRanges&&(d=I(this.nativeSelection,
this.rangeCount-1))&&!v.rangesEqual(d,a)&&(a=new t(d)),this._ranges[this.rangeCount-1]=a,e(this,a,K(this.nativeSelection)),this.isCollapsed=E(this)):this.refresh()}}:function(a,b){b&&N?F(this,a):(this.nativeSelection.addRange(g(a)),this.refresh())};m.setRanges=function(a){if(C&&1<a.length)u(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(s.isHostMethod(y,"empty")&&s.isHostMethod(L,"select")&&C&&x)m.removeAllRanges=function(){try{if(this.docSelection.empty(),
...
a,!1))},m.setRanges=function(a){this.removeAllRanges();var b=a.length;1<b?u(this,a):b&&this.addRange(a[0])};else return c.fail("No means of selecting a Range or TextRange was found"),!1;m.getRangeAt=function(a){if(0>a||a>=this.rangeCount)throw new w("INDEX_SIZE_ERR");return this._ranges[a]};var J;if(x)J=function(a){var c;b.isSelectionValid(a.win)?c=a.docSelection.createRange():(c=r.getBody(a.win.document).createTextRange(),c.collapse(!0));"Control"==a.docSelection.type?l(a):c&&"undefined"!=typeof c.text?
h(a,c):f(a)};else if(s.isHostMethod(y,"getRangeAt")&&"number"==typeof y.rangeCount)J=function(a){if(C&&B&&"Control"==a.docSelection.type)l(a);else if(a._ranges.length=a.rangeCount=a.nativeSelection.rangeCount,a.rangeCount){for(var c=0,d=a.rangeCount;c<d;++c)a._ranges[c]=new b.WrappedRange(a.nativeSelection.getRangeAt(c));e(a,a._ranges[a.rangeCount-1],K(a.nativeSelection));a.isCollapsed=E(a)}else f(a)};else if(G&&"boolean"==typeof y.isCollapsed&&"boolean"==typeof L.collapsed&&b.features.implementsDomRange)J=
...
document)},displaysCaretInEmptyContentEditableCorrectly:function(){return a},hasCurrentStyleProperty:function(){return"currentStyle"in c},hasHistoryIssue:function(){return d},insertsLineBreaksOnReturn:function(){return d},supportsPlaceholderAttributeOn:function(a){return"placeholder"in a},supportsEvent:function(a){var b;(b="on"+a in c)||(c.setAttribute("on"+a,"return;"),b="function"===typeof c["on"+a]);return b},supportsEventsInIframeCorrectly:function(){return!g},supportsHTML5Tags:function(a){a=
a.createElement("div");a.innerHTML="<article>foo</article>";return"<article>foo</article>"===a.innerHTML.toLowerCase()},supportsCommand:function(){var b={formatBlock:a,insertUnorderedList:a||e,insertOrderedList:a||e},c={insertHTML:d};return function(a,d){if(!b[d]){try{return a.queryCommandSupported(d)}catch(e){}try{return a.queryCommandEnabled(d)}catch(f){return!!c[d]}}return!1}}(),doesAutoLinkingInContentEditable:function(){return a},canDisableAutoLinking:function(){return this.supportsCommand(document,
"AutoUrlDetect")},clearsContentEditableCorrectly:function(){return d||g||e},supportsGetAttributeCorrectly:function(){return"1"!=document.createElement("td").getAttribute("rowspan")},canSelectImagesInContentEditable:function(){return d||a||g},autoScrollsToCaret:function(){return!e},autoClosesUnclosedTags:function(){var a=c.cloneNode(!1),b;a.innerHTML="<p><div></div>";a=a.innerHTML.toLowerCase();b="<p></p><div></div>"===a||"<p><div></div></p>"===a;this.autoClosesUnclosedTags=function(){return b};return b},
...
hasProblemsSettingCaretAfterImg:function(){return a},hasUndoInContextMenu:function(){return d||f||g},hasInsertNodeIssue:function(){return g},hasIframeFocusIssue:function(){return a},createsNestedInvalidMarkupAfterPaste:function(){return e}}}();
...
(function(b){function c(a){return a.replace(e,function(a,b){var c=(b.match(f)||[])[1]||"",d=k[c];b=b.replace(f,"");b.split(d).length>b.split(c).length&&(b+=c,c="");var e=d=b;b.length>g&&(e=e.substr(0,g)+"...");"www."===d.substr(0,4)&&(d="http://"+d);return'<a href="'+d+'">'+e+"</a>"+c})}function a(h){if(!d.contains(h.nodeName))if(h.nodeType===b.TEXT_NODE&&h.data.match(e)){var l=h.parentNode,f;f=l.ownerDocument;var g=f._wysihtml5_tempElement;g||(g=f._wysihtml5_tempElement=f.createElement("div"));f=
g;f.innerHTML="<span></span>"+c(h.data);for(f.removeChild(f.firstChild);f.firstChild;)l.insertBefore(f.firstChild,h);l.removeChild(h)}else{l=b.lang.array(h.childNodes).get();f=l.length;for(g=0;g<f;g++)a(l[g]);return h}}var d=b.lang.array("CODE PRE A SCRIPT HEAD TITLE STYLE".split(" ")),e=/((https?:\/\/|www\.)[^\s<]{3,})/gi,f=/([^\w\/\-](,?))$/i,g=100,k={")":"(","]":"[","}":"{"};b.dom.autoLink=function(b){var c;a:{c=b;for(var e;c.parentNode;){c=c.parentNode;e=c.nodeName;if(d.contains(e)){c=!0;break a}if("body"===
...
n;if(g.getComputedStyle)return f&&(n=k.overflow,k.overflow="hidden"),e=g.getComputedStyle(e,null).getPropertyValue(a),f&&(k.overflow=n||""),e}}}}}();wysihtml5.dom.hasElementWithTagName=function(){var b={},c=1;return function(a,d){var e=(a._wysihtml5_identifier||(a._wysihtml5_identifier=c++))+":"+d,f=b[e];f||(f=b[e]=a.getElementsByTagName(d));return 0<f.length}}();
...
e,d)}}};
wysihtml5.dom.parse=function(){function b(c,e){var h=c.childNodes,f=h.length,l=a[c.nodeType],g=0,p,l=l&&l(c);if(!l)return null;for(g=0;g<f;g++)(p=b(h[g],e))&&l.appendChild(p);if(e&&!(l.nodeName.toLowerCase()!==d||l.childNodes.length&&l.attributes.length)){for(h=l.ownerDocument.createDocumentFragment();l.firstChild;)h.appendChild(l.firstChild);return h}return l}function c(a,b){b=b.toLowerCase();var c;if(c="IMG"==a.nodeName)if(c="src"==b){var d;a:{try{d=a.complete&&!a.mozMatchesSelector(":-moz-broken");break a}catch(e){if(a.complete&&
"complete"===a.readyState){d=!0;break a}}d=void 0}c=!0===d}return c?a.src:k&&"outerHTML"in a?-1!=a.outerHTML.toLowerCase().indexOf(" "+b+"=")?a.getAttribute(b):null:a.getAttribute(b)}var a={1:function(a){var b,h,f=g.tags;h=a.nodeName.toLowerCase();b=a.scopeName;if(a._wysihtml5)return null;a._wysihtml5=1;if("wysihtml5-temp"===a.className)return null;b&&"HTML"!=b&&(h=b+":"+h);"outerHTML"in a&&(wysihtml5.browser.autoClosesUnclosedTags()||"P"!==a.nodeName||"</p>"===a.outerHTML.slice(-4).toLowerCase()||
...
(function(b){function c(a){var b=a.ownerDocument.createElement("br");a.appendChild(b)}b.resolveList=function(a,d){if(a.nodeName.match(/^(MENU|UL|OL)$/)){var e=a.ownerDocument,f=e.createDocumentFragment(),g=a.previousElementSibling||a.previousSibling,k,h;if(d)for(g&&"block"!==b.getStyle("display").from(g)&&c(f);h=a.firstElementChild||a.firstChild;){for(e=h.lastChild;g=h.firstChild;)k=(k=g===e)&&"block"!==b.getStyle("display").from(g)&&"BR"!==g.nodeName,f.appendChild(g),k&&c(f);h.parentNode.removeChild(h)}else for(;h=
a.firstElementChild||a.firstChild;){if(h.querySelector&&h.querySelector("div, p, ul, ol, menu, blockquote, h1, h2, h3, h4, h5, h6"))for(;g=h.firstChild;)f.appendChild(g);else{for(k=e.createElement("p");g=h.firstChild;)k.appendChild(g);f.appendChild(k)}h.parentNode.removeChild(h)}a.parentNode.replaceChild(f,a)}}})(wysihtml5.dom);
...
function(){})}catch(n){}if(!b.browser.crashesWhenDefineProperty(c))try{var u={get:function(){return d}};e&&(u.set=function(){});Object.defineProperty(a,c,u)}catch(D){}}})})(wysihtml5);(function(){var b={className:"class"};wysihtml5.dom.setAttributes=function(c){return{on:function(a){for(var d in c)a.setAttribute(b[d]||d,c[d])}}}})();
...
wysihtml5.quirks.countChildNodes=function(){return function(b){var c=20;b.insertAdjacentHTML("afterbegin","<div>"+b.innerHTML+" &nbsp;</div>");var a=Math.max(b.firstElementChild.offsetHeight,b.firstElementChild.clientHeight);b.removeChild(b.firstElementChild);return c+a}}();
...
g);try{h.parentNode.removeChild(h)}catch(n){}}else a(e,e)},executeAndRestoreSimple:function(a){var b,c,f=this.getRange(),g=this.doc.body,k;if(f){b=f.getNodes([3]);g=b[0]||f.startContainer;k=b[b.length-1]||f.endContainer;b=g===f.startContainer?f.startOffset:0;c=k===f.endContainer?f.endOffset:k.length;try{a(f.startContainer,f.endContainer)}catch(h){setTimeout(function(){throw h;},0)}a=rangy.createRange(this.doc);try{a.setStart(g,b)}catch(l){}try{a.setEnd(k,c)}catch(p){}try{this.setSelection(a)}catch(n){}}else a(g,
...
a.tagName.toLowerCase())&&d)return a;a=a.parentNode}return!1},postApply:function(a,b){for(var c=a[0],d=a[a.length-1],f=[],g,k=c,r=d,s=0,v=d.length,t,w,A=0,z=a.length;A<z;++A)t=a[A],(w=this.getAdjacentMergeableTextNode(t.parentNode,!1))?(g||(g=new e(w),f.push(g)),g.textNodes.push(t),t===c&&(k=g.firstTextNode,s=k.length),t===d&&(r=g.firstTextNode,v=g.getLength())):g=null;if(c=this.getAdjacentMergeableTextNode(d.parentNode,!0))g||(g=new e(d),f.push(g)),g.textNodes.push(c);if(f.length){A=0;for(z=f.length;A<
...
(function(b){function c(c,g){var k=c.doc,h="_wysihtml5-temp-"+ +new Date,l=0,p,n,u;b.commands.formatInline.exec(c,a,d,h,/non-matching-class/g);p=k.querySelectorAll(d+"."+h);for(h=p.length;l<h;l++)for(u in n=p[l],n.removeAttribute("class"),g)n.setAttribute(u,g[u]);l=n;1===h&&(u=e.getTextContent(n),h=!!n.querySelector("*"),u=""===u||u===b.INVISIBLE_SPACE,!h&&u&&(e.setTextContent(n,g.text||n.href),k=k.createTextNode(" "),c.selection.setAfter(n),e.insert(k).after(n),l=k));c.selection.setAfter(l)}var a,
...
c.substr(0,6)&&(a.className+=" "+e))});a.execCommand(c,!1,d);f&&f.stop()}function f(d,e){d.selection.selectLine();d.selection.surround(e);var f=a(e),g=c(e);f&&"BR"===f.nodeName&&f.parentNode.removeChild(f);g&&"BR"===g.nodeName&&g.parentNode.removeChild(g);(f=e.lastChild)&&"BR"===f.nodeName&&f.parentNode.removeChild(f);d.selection.selectNode(e,b.browser.displaysCaretInEmptyContentEditableCorrectly())}var g=b.dom,k="H1 H2 H3 H4 H5 H6 P BLOCKQUOTE DIV".split(" ");b.commands.formatBlock={exec:function(h,
l,p,n,u){var D=h.doc,q=this.state(h,l,p,n,u),r=h.config.useLineBreaks,s=r?"DIV":"P",v;p="string"===typeof p?p.toUpperCase():p;if(q)h.selection.executeAndRestoreSimple(function(){u&&(q.className=q.className.replace(u,""));if(b.lang.string(q.className).trim()||!r&&"P"!==p)g.renameElement(q,"P"===p?"DIV":s);else{var e=q,f=e.ownerDocument,h=a(e),l=c(e);h&&!d(h)&&e.parentNode.insertBefore(f.createElement("br"),h);l&&!d(l)&&e.parentNode.insertBefore(f.createElement("br"),e);g.replaceWithChildNodes(q)}});
else{if(null===p||b.lang.array(k).contains(p))if(v=h.selection.getSelectedNode(),q=g.getParentElement(v,{nodeName:k})){h.selection.executeAndRestore(function(){p&&(q=g.renameElement(q,p));if(n){var a=q;a.className?(a.className=a.className.replace(u,""),a.className+=" "+n):a.className=n}});return}h.commands.support(l)?e(D,l,p||s,n):(q=D.createElement(p||s),n&&(q.className=n),f(h,q))}},state:function(a,b,c,d,e){c="string"===typeof c?c.toUpperCase():c;a=a.selection.getSelectedNode();return g.getParentElement(a,
{nodeName:c,className:d,classRegExp:e})}}})(wysihtml5);
(function(b){function c(c,f,g){var k=c+":"+f;if(!d[k]){var h=d,l=b.selection.HTMLApplier,p=a[c];c=p?[c.toLowerCase(),p.toLowerCase()]:[c.toLowerCase()];h[k]=new l(c,f,g,!0)}return d[k]}var a={strong:"b",em:"i",b:"strong",i:"em"},d={};b.commands.formatInline={exec:function(a,b,d,k,h){b=a.selection.getRange();if(!b)return!1;c(d,k,h).toggleRange(b);a.selection.setSelection(b)},state:function(d,f,g,k,h){f=d.doc;var l=a[g]||g;return!b.dom.hasElementWithTagName(f,g)&&!b.dom.hasElementWithTagName(f,l)||
k&&!b.dom.hasElementWithClassName(f,k)?!1:(d=d.selection.getRange())?c(g,k,h).isAppliedToRange(d):!1}}})(wysihtml5);wysihtml5.commands.insertHTML={exec:function(b,c,a){b.commands.support(c)?b.doc.execCommand(c,!1,a):b.selection.insertHTML(a)},state:function(){return!1}};
...
wysihtml5.commands.insertUnorderedList={exec:function(b,c){var a=b.doc,d=b.selection.getSelectedNode(),e=wysihtml5.dom.getParentElement(d,{nodeName:"UL"}),f=wysihtml5.dom.getParentElement(d,{nodeName:"OL"}),d="_wysihtml5-temp-"+(new Date).getTime(),g;e||f||!b.commands.support(c)?e?b.selection.executeAndRestore(function(){wysihtml5.dom.resolveList(e,b.config.useLineBreaks)}):f?b.selection.executeAndRestore(function(){wysihtml5.dom.renameElement(f,"ul")}):(b.commands.exec("formatBlock","div",d),g=a.querySelector("."+
d),a=""===g.innerHTML||g.innerHTML===wysihtml5.INVISIBLE_SPACE||"<br>"===g.innerHTML,b.selection.executeAndRestore(function(){e=wysihtml5.dom.convertToList(g,"ul")}),a&&b.selection.selectNode(e.querySelector("li"),!0)):a.execCommand(c,!1,null)},state:function(b){b=b.selection.getSelectedNode();return wysihtml5.dom.getParentElement(b,{nodeName:"UL"})}};
wysihtml5.commands.italic={exec:function(b,c){return wysihtml5.commands.formatInline.exec(b,c,"i")},state:function(b,c){return wysihtml5.commands.formatInline.state(b,c,"i")}};(function(b){var c=/wysiwyg-text-align-[0-9a-z]+/g;b.commands.justifyCenter={exec:function(a,d){return b.commands.formatBlock.exec(a,"formatBlock",null,"wysiwyg-text-align-center",c)},state:function(a,d){return b.commands.formatBlock.state(a,"formatBlock",null,"wysiwyg-text-align-center",c)}}})(wysihtml5);
...
b){c.autoLink(b.parentNode)})}),c.observe(this.element,"blur",function(){c.autoLink(d.element)});var g=this.sandbox.getDocument().getElementsByTagName("a"),k=c.autoLink.URL_REG_EXP,h=function(a){a=b.lang.string(c.getTextContent(a)).trim();"www."===a.substr(0,4)&&(a="http://"+a);return a};c.observe(this.element,"keydown",function(a){if(g.length){a=d.selection.getSelectedNode(a.target.ownerDocument);var b=c.getParentElement(a,{nodeName:"A"},4),e;b&&(e=h(b),setTimeout(function(){var a=h(b);a!==e&&a.match(k)&&
b.setAttribute("href",a)},0))}})}},_initObjectResizing:function(){this.commands.exec("enableObjectResizing",!0);if(a.supportsEvent("resizeend")){var d=["width","height"],e=d.length,f=this.element;c.observe(f,"resizeend",function(a){a=a.target||a.srcElement;var c=a.style,h=0,l;if("IMG"===a.nodeName){for(;h<e;h++)l=d[h],c[l]&&(a.setAttribute(l,parseInt(c[l],10)),c[l]="");b.quirks.redraw(f)}})}},_initUndoManager:function(){this.undoManager=new b.UndoManager(this.parent)},_initLineBreaking:function(){function d(a){var b=
c.getParentElement(a,{nodeName:["P","DIV"]},2);b&&e.selection.executeAndRestore(function(){e.config.useLineBreaks?c.replaceWithChildNodes(b):"P"!==b.nodeName&&c.renameElement(b,"p")})}var e=this,f="LI P H1 H2 H3 H4 H5 H6".split(" "),g=["UL","OL","MENU"];this.config.useLineBreaks||c.observe(this.element,["focus","keydown"],function(){if(e.isEmpty()){var b=e.doc.createElement("P");e.element.innerHTML="";e.element.appendChild(b);a.displaysCaretInEmptyContentEditableCorrectly()?e.selection.selectNode(b,
!0):(b.innerHTML="<br>",e.selection.setBefore(b.firstChild))}});a.createsNestedInvalidMarkupAfterPaste()&&c.observe(this.element,"paste",function(a){a=e.doc.createTextNode(b.INVISIBLE_SPACE);e.selection.insertNode(a)});c.observe(this.doc,"keydown",function(a){var h=a.keyCode;if(!a.shiftKey&&(h===b.ENTER_KEY||h===b.BACKSPACE_KEY)){var l=c.getParentElement(e.selection.getSelectedNode(),{nodeName:f},4);l?setTimeout(function(){var a=e.selection.getSelectedNode(),f;if("LI"===l.nodeName){if(!a)return;(f=
c.getParentElement(a,{nodeName:g},2))||d(a)}h===b.ENTER_KEY&&l.nodeName.match(/^H[1-6]$/)&&d(a)},0):e.config.useLineBreaks&&h===b.ENTER_KEY&&!b.browser.insertsLineBreaksOnReturn()&&(e.commands.exec("insertLineBreak"),a.preventDefault())}})}})})(wysihtml5);
...
(function(b){var c={name:void 0,style:!0,toolbar:void 0,autoLink:!0,autoResize:!0,parserRules:{tags:{br:{},span:{},div:{},p:{}},classes:{}},parser:b.dom.parse,composerClassName:"wysihtml5-editor",bodyClassName:"wysihtml5-supported",useLineBreaks:!0,stylesheets:[],placeholderText:void 0,supportTouchDevices:!0,cleanUp:!0};b.Editor=b.lang.Dispatcher.extend({constructor:function(a,d){this.textareaElement="string"===typeof a?document.getElementById(a):a;this.config=b.lang.object({}).merge(c).merge(d).get();
this.currentView=this.textarea=new b.views.Textarea(this,this.textareaElement,this.config);this._isCompatible=b.browser.supported();if(!this._isCompatible||!this.config.supportTouchDevices&&b.browser.isTouchDevice()){var e=this;setTimeout(function(){e.fire("beforeload").fire("load")},0)}else b.dom.addClass(document.body,this.config.bodyClassName),this.currentView=this.composer=new b.views.Composer(this,this.textareaElement,this.config),"function"===typeof this.config.parser&&this._initParser(),!0===
this.config.autoResize&&this._initAutoResize(),this.on("beforeload",function(){this.synchronizer=new b.views.Synchronizer(this,this.textarea,this.composer);this.config.toolbar&&(this.toolbar=new b.toolbar.Toolbar(this,this.config.toolbar))})},isCompatible:function(){return this._isCompatible},clear:function(){this.currentView.clear();return this},getValue:function(a){return this.currentView.getValue(a)},setValue:function(a,b){this.fire("unset_placeholder");if(!a)return this.clear();this.currentView.setValue(a,
b);return this},focus:function(a){this.currentView.focus(a);return this},disable:function(){this.currentView.disable();return this},enable:function(){this.currentView.enable();return this},isEmpty:function(){return this.currentView.isEmpty()},hasPlaceholderSet:function(){return this.currentView.hasPlaceholderSet()},parse:function(a){var c=this.config.parser(a,this.config.parserRules,this.composer.sandbox.getDocument(),this.config.cleanUp);"object"===typeof a&&b.quirks.redraw(a);return c},autoResize:function(a){setTimeout(function(){var b=
a.composer.iframe,f=b.contentWindow.document.getElementsByTagName("html")[0],g=b.parentNode,k=f.lastChild;f.style.height="100%";f.style.width="100%";f.style.overflow="hidden";k.style.height="auto";k.style.lineHeight="20px";k.style.width="100%";b.style.height="100%";g.style.height="100%";a.on("aftercommand:composer",c);a.on("change_view",c);a.on("newword:composer",c);a.on("undo:composer",c);a.on("paste",c);a.on("focus",c);a.on("blur",c);k.addEventListener("keyup",c,!1);k.addEventListener("keydown",
c,!1);k.addEventListener("keypress",c,!1);k.addEventListener("blur",c,!1);k.addEventListener("focus",c,!1);a.on("load",c);c()},200);var c=function(){var c=a.composer.iframe,d=c.contentWindow.document.getElementsByTagName("html")[0].lastChild,d=b.quirks.countChildNodes(d);c.style.height=d+"px"}},_initAutoResize:function(){this.autoResize(this)},_initParser:function(){this.on("paste:composer",function(){var a=this;a.composer.selection.executeAndRestore(function(){b.quirks.cleanPastedHTML(a.composer.element);
